...
def RegisterOpenAI_Ros_Env(task_env, max_episode_steps=10000):
    ...
    elif task_env == 'Ur3Position-v0':
        register(
            id=task_env,
            entry_point='openai_ros.task_envs.ur3.ur3_position_task:UR3PositionEnv',
            max_episode_steps=max_episode_steps,
        )

        # import our training environment
        from openai_ros.task_envs.ur3 import ur3_position_task
    elif task_env == 'Ur5Position-v0':
        register(
            id=task_env,
            entry_point='openai_ros.task_envs.ur5.ur5_position_task:UR5PositionEnv',
            max_episode_steps=max_episode_steps,
        )

        # import our training environment
        from openai_ros.task_envs.ur5 import ur5_position_task

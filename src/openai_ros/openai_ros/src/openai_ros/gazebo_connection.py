...
from gazebo_msgs.srv import SetPhysicsProperties, SetPhysicsPropertiesRequest, SetModelState, SetModelStateRequest, SetModelStateResponse
...
class GazeboConnection():
    ...
    def resetWorld(self):
        ...
        # try:
        #     self.set_bolt_position('bolt1', [random.uniform(-0.2, 0.2), random.uniform(0.35, 0.65), 0.31])
        #     self.set_bolt_position('bolt2', [random.uniform(-0.2, 0.2), random.uniform(0.35, 0.65), 0.31])
        #     self.set_bolt_position('bolt3', [random.uniform(-0.2, 0.2), random.uniform(0.35, 0.65), 0.31])
        #     self.set_bolt_position('bolt4', [random.uniform(-0.2, 0.2), random.uniform(0.35, 0.65), 0.31])
        #     self.set_bolt_position('bolt5', [random.uniform(-0.2, 0.2), random.uniform(0.35, 0.65), 0.31])
        # except rospy.ServiceException as e:
        #     print("/gazebo/set_model_state service call failed")

    # def set_bolt_position(self, model_name, position):

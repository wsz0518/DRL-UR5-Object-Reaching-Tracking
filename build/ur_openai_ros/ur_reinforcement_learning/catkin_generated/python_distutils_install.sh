...
echo_and_run cd "/home/sizhewin/drl_obj_reaching_tracking/src/ur_openai_ros/ur_reinforcement_learning"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/sizhewin/drl_obj_reaching_tracking/src/ur_openai_ros/ur_reinforcement_learning/setup.py" \
     \
    build --build-base "/home/sizhewin/drl_obj_reaching_tracking/build/ur_openai_ros/ur_reinforcement_learning" \
    install \
    --root="${DESTDIR-/}" \

...
echo_and_run cd "/home/sizhewin/drl_obj_reaching_tracking/src/ur_openai_ros/ur_training"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/sizhewin/drl_obj_reaching_tracking/src/ur_openai_ros/ur_training/setup.py" \
     \
    build --build-base "/home/sizhewin/drl_obj_reaching_tracking/build/ur_openai_ros/ur_training" \
    install \
    --root="${DESTDIR-/}" \

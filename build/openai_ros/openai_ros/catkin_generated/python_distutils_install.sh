...
echo_and_run cd "/home/sizhewin/drl_obj_reaching_tracking/src/openai_ros/openai_ros"
...
echo_and_run /usr/bin/env \
    ...
    "/home/sizhewin/drl_obj_reaching_tracking/src/openai_ros/openai_ros/setup.py" \
     \
    build --build-base "/home/sizhewin/drl_obj_reaching_tracking/build/openai_ros/openai_ros" \
    install \
    --root="${DESTDIR-/}" \

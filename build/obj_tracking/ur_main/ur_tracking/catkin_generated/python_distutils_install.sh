...
echo_and_run cd "/home/sizhewin/drl_obj_reaching_tracking/src/obj_tracking/ur_main/ur_tracking"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/sizhewin/drl_obj_reaching_tracking/src/obj_tracking/ur_main/ur_tracking/setup.py" \
     \
    build --build-base "/home/sizhewin/drl_obj_reaching_tracking/build/obj_tracking/ur_main/ur_tracking" \
    install \
    --root="${DESTDIR-/}" \
